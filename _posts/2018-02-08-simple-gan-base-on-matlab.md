...
![图2 将generator和discriminator看成一个整体](/imgs/simple-gan-base-on-matlab/generator-and-discriminator.png)
...
```
结果
![epoch_5_t_1000.png](/imgs/simple-gan-base-on-matlab/example1-result1.png)
